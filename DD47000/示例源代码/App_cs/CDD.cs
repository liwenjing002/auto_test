...
namespace App_csharp
{
    ...
    class CDD
    {
        ...
        public pDD_mov mov;       // 鼠标移动
        public pDD_key key;          // 键盘按键
        public pDD_chk chk;           // 驱动检测
        ...
        private int GetDDfunAddress(IntPtr hinst)
        {
            ...
            if (ptr.Equals(IntPtr.Zero)) { return -1; }
            ptr = GetProcAddress(hinst, "DD_chk");
            chk = Marshal.GetDelegateForFunctionPointer(ptr, typeof(pDD_chk)) as pDD_chk;
