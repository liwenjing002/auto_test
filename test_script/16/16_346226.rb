...
b = do_input b,{:id=>"user",:type=>"input",:class=>"ps_text",:name=>"username",},''

b = do_input b,{:id=>"input-password",:type=>"input",:class=>"ps_text",:name=>"password",},''
...
b = do_input b,{:id=>"charge",:type=>"input",:class=>"user_name validate[required,funcCall[X.V.checkCrash]]",:name=>"money",},'2'
