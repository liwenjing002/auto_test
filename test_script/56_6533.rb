...
b = do_url b,'http://www.firstp2p.com/'
...
b = do_input b,{:id=>"charge",:type=>"input",:class=>"user_name validate[required,funcCall[X.V.checkCrash]]",:name=>"money",},'0.1'
...
b = do_click b,{:type=>"radio",:value=>"CMBC_1111010_01",:class=>"jdradio",:name=>"bankRadio",},''
