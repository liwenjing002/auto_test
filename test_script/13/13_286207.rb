...
b = do_click b,{:id=>"user",:type=>"input",:class=>"ps_text",:name=>"username",},''
...
b = do_input b,{:id=>"charge",:type=>"input",:class=>"user_name validate[required,funcCall[X.V.checkCrash]]",:name=>"money",},'10000000'
