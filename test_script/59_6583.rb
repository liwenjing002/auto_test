...
b = do_click b,{:id=>"cardNumber",:type=>"input",:class=>"ipt_txt CardDefault txtclick",:name=>"cardNumber",},''
b = do_input b,{:id=>"cardNumber",:type=>"input",:class=>"ipt_txt CardDefault txtclick",:name=>"cardNumber",},'6222988812340000'
