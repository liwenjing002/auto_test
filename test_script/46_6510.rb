...
b = do_checkCode b,{:id=>"checkCode",:type=>"input",:class=>"input-block-level wx add-mgt10",:name=>"checkCode",},'idcode:(.{4})'
b = do_click b,{:type=>"button",:class=>"btn btn-large btn-primary sign-in-btn",:text=>"登 录",},''
b = do_assert b,{:type=>"span",:class=>"name",:text=>"您好，康钱磊",},'您好，康钱磊'
b.quit
